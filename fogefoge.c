...
int praondefantasmavai(int xatual, int yatual, int* xdestino,int* ydestino){
	int i;
	// 4 opcoes de direcao para x ou para y
	int opcoes[4][2] = {
		{xatual, yatual + 1},
		{xatual + 1, yatual},
		{xatual, yatual - 1},
...
int main() {
	...
	} while(!heroiVive() && !qtdFantamas());

	if(qtdFantamas())
		printf("VOCE PEGOU TODOS OS FANTASMAS\n");
	else if(heroiVive()){
		printf("OS FANTASMAS PEGARAM VOCE\n");
	}
